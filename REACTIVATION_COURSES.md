# 🎓 Réactivation du Système de Formations
...
### 2. Copier et exécuter cette migration :
...
## ✅ Étape 3 : Activer Realtime (Optionnel)

Dans Supabase Dashboard :
1. Allez dans **Database** → **Replication**
2. Activez pour ces tables :
   - ✅ courses
   - ✅ course_enrollments
   - ✅ lesson_progress
   - ✅ course_discussions
...
1. **Créer une formation** :
   - Allez dans Profile → Seller Tools
   - Cliquez sur "Create Course"
   - Remplissez le formulaire

2. **Ajouter des modules** :
   - Créez des chapitres
   - Ajoutez des leçons avec vidéos

3. **Tester l'inscription** :
   - Avec un autre compte, inscrivez-vous à la formation
   - Suivez les leçons
   - Complétez les quiz

4. **Vérifier les certificats** :
   - Complétez 100% d'une formation
   - Le certificat devrait être généré automatiquement
...
git add .
git commit -m "Réactivation du système de formations"
git push
...
### Pour les Créateurs :
- ✅ Créer des formations complètes
- ✅ Organiser en modules et leçons
- ✅ Ajouter des vidéos et du contenu
- ✅ Créer des quiz
...
Votre plateforme de formations est maintenant complète avec :
...
**Votre marketplace est maintenant une plateforme d'apprentissage complète !** 🚀
